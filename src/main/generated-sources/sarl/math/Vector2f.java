...
public class Vector2f extends Tuple2f<Vector2f> {
   ...
   */
  @DefaultValueSource
  public Vector2f(final Tuple2f<?> tuple, @DefaultValue("math.Vector2f#NEW_0") final boolean normalize) {
    super(tuple);
    if (normalize) {
      this.safeNormalize();
    }
   ...
   */
  @DefaultValueSource
  public Vector2f(final int[] tuple, @DefaultValue("math.Vector2f#NEW_1") final boolean normalize) {
    super(tuple);
    if (normalize) {
      this.safeNormalize();
    }
   ...
   */
  @DefaultValueSource
  public Vector2f(final float[] tuple, @DefaultValue("math.Vector2f#NEW_2") final boolean normalize) {
    super(tuple);
    if (normalize) {
      this.safeNormalize();
    }
   ...
   */
  @DefaultValueSource
  public Vector2f(final long[] tuple, @DefaultValue("math.Vector2f#NEW_3") final boolean normalize) {
    super(tuple);
    if (normalize) {
      this.safeNormalize();
    }
   ...
   */
  @DefaultValueSource
  public Vector2f(final double[] tuple, @DefaultValue("math.Vector2f#NEW_4") final boolean normalize) {
    super(tuple);
    if (normalize) {
      this.safeNormalize();
    }
   ...
   */
  @DefaultValueSource
  public Vector2f(final int x, final int y, @DefaultValue("math.Vector2f#NEW_5") final boolean normalize) {
    super(x, y);
    if (normalize) {
      this.safeNormalize();
    }
   ...
   */
  @DefaultValueSource
  public Vector2f(final float x, final float y, @DefaultValue("math.Vector2f#NEW_6") final boolean normalize) {
    super(x, y);
    if (normalize) {
      this.safeNormalize();
    }
   ...
   */
  @DefaultValueSource
  public Vector2f(final long x, final long y, @DefaultValue("math.Vector2f#NEW_7") final boolean normalize) {
    super(x, y);
    if (normalize) {
      this.safeNormalize();
    }
   ...
   */
  @DefaultValueSource
  public Vector2f(final double x, final double y, @DefaultValue("math.Vector2f#NEW_8") final boolean normalize) {
    super(x, y);
    if (normalize) {
      this.safeNormalize();
    }
   ...
   */
  @DefaultValueUse("math.Tuple2f<?>,boolean")
  @SyntheticMember
  ...
  @SyntheticMember
  private final static long serialVersionUID = 2530676004L;
}
